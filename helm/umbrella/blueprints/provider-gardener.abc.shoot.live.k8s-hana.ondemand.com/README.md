...
|------------|------|---------|
| oci://ghcr.io/openmcp-project | crossplane-gardener-shoot-clusters(crossplane-gardener-shoot-clusters) | 0.0.11 |
...
| oci://ghcr.io/openmcp-project | external-secrets-config(external-secrets-config) | 0.1.11 |
# TL;DR
