...
|------------|------|---------|
|  https://raw.githubusercontent.com/openmcp-project/blueprint-building-blocks/gh-pages/ | crossplane-provider-apiextensions-composition(crossplane-provider-apiextensions-composition) | 0.0.8 |
|  https://raw.githubusercontent.com/openmcp-project/blueprint-building-blocks/gh-pages/ | crossplane-provider-aws-ec2(crossplane-provider-aws-ec2) | 0.0.9 |
|  https://raw.githubusercontent.com/openmcp-project/blueprint-building-blocks/gh-pages/ | crossplane-provider-aws-eks(crossplane-provider-aws-eks) | 0.0.9 |
|  https://raw.githubusercontent.com/openmcp-project/blueprint-building-blocks/gh-pages/ | crossplane-provider-aws-iam(crossplane-provider-aws-iam) | 0.0.10 |
|  https://raw.githubusercontent.com/openmcp-project/blueprint-building-blocks/gh-pages/ | crossplane-provider-aws-rdr(crossplane-provider-aws-rdr) | 0.0.8 |
...
| crossplane-provider-apiextensions-composition.compositions[0].spec.resources[0].base.spec.forProvider.region | string | `"us-east-2"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[0].spec.resources[0].patches[0].transforms[0].map.US | string | `"us-east-2"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[0].spec.resources[1].base.spec.forProvider.region | string | `"us-east-2"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[0].spec.resources[1].patches[0].transforms[0].map.US | string | `"us-east-2"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.compositeTypeRef.kind | string | `"XEKSCluster"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[0].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[10].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[11].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[12].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[13].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[13].base.spec.writeConnectionSecretToRef.name | string | `"dev-us-connection-secret"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[14].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[15].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[16].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[16].patches[3].transforms[0].map.gpu | string | `"AL2_x86_64_GPU"` |  |
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[16].patches[3].transforms[0].map.non-gpu | string | `"AL2_x86_64"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[1].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[2].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[3].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[4].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[5].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[6].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[7].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[8].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-apiextensions-composition.compositions[1].spec.pipeline[0].input.resources[9].base.spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-aws-ec2.eips[0].name | string | `"dev-us-ekscluster"` |  |
| crossplane-provider-aws-ec2.eips[0].spec.forProvider.domain | string | `"vpc"` |  |
| crossplane-provider-aws-ec2.eips[0].spec.forProvider.region | string | `"us-west-2"` |  |
| crossplane-provider-aws-ec2.eips[0].spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
| crossplane-provider-aws-ec2.eips[1].name | string | `"dev-us-ekscluster-2"` |  |
| crossplane-provider-aws-ec2.eips[1].spec.forProvider.domain | string | `"vpc"` |  |
| crossplane-provider-aws-ec2.eips[1].spec.forProvider.region | string | `"us-west-2"` |  |
| crossplane-provider-aws-ec2.eips[1].spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
| crossplane-provider-aws-ec2.internetGateways | list | `[{"annotations":{},"labels":{},"name":"dev-us-ekscluster","ownerReferences":{},"spec":{"forProvider":{"region":"us-west-2","vpcIdSelector":{"matchControllerRef":true}},"providerConfigRef":{"name":"dev-us-aws"}}},{"annotations":{},"labels":{},"name":"reference-eks-network","ownerReferences":{},"spec":{"forProvider":{"region":"us-east-1","tags":{"Name":"platform-ref-eks-network-internet-gateway"},"vpcIdSelector":{"matchControllerRef":true}},"providerConfigRef":{"name":"dev-us-aws"}}}]` | https://marketplace.upbound.io/providers/upbound/provider-aws-ec2/v1.11.0/resources/ec2.aws.upbound.io/InternetGateway/v1beta1 |
...
| crossplane-provider-aws-ec2.mainRouteTableAssociations[0].spec.forProvider.region | string | `"us-east-1"` |  |
...
| crossplane-provider-aws-ec2.mainRouteTableAssociations[0].spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
| crossplane-provider-aws-ec2.natGateways | list | `[{"annotations":{},"labels":{},"name":"dev-us-ekscluster","ownerReferences":{},"spec":{"forProvider":{"allocationIdSelector":{"matchLabels":{"type":"eip-1"}},"region":"us-west-2","subnetIdSelector":{"matchLabels":{"type":"subnet","visibility":"public","zone":"us-west-2a"}}},"providerConfigRef":{"name":"dev-us-aws"}}},{"annotations":{},"labels":{},"name":"dev-us-ekscluster-2","ownerReferences":{},"spec":{"forProvider":{"allocationIdSelector":{"matchLabels":{"type":"eip-2"}},"region":"us-west-2","subnetIdSelector":{"matchLabels":{"type":"subnet","visibility":"public","zone":"us-west-2b"}}},"providerConfigRef":{"name":"dev-us-aws"}}}]` | https://marketplace.upbound.io/providers/upbound/provider-aws-ec2/v1.11.0/resources/ec2.aws.upbound.io/NATGateway/v1beta1 |
...
| crossplane-provider-aws-ec2.routeTableAssociations[0].spec.forProvider.region | string | `"us-east-1"` |  |
...
| crossplane-provider-aws-ec2.routeTableAssociations[0].spec.forProvider.subnetIdSelector.matchLabels.zone | string | `"us-east-1a"` |  |
| crossplane-provider-aws-ec2.routeTableAssociations[0].spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-aws-ec2.routeTableAssociations[1].spec.forProvider.region | string | `"us-east-1"` |  |
...
| crossplane-provider-aws-ec2.routeTableAssociations[1].spec.forProvider.subnetIdSelector.matchLabels.zone | string | `"us-east-1a"` |  |
| crossplane-provider-aws-ec2.routeTableAssociations[1].spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-aws-ec2.routeTableAssociations[2].spec.forProvider.region | string | `"us-east-1"` |  |
...
| crossplane-provider-aws-ec2.routeTableAssociations[2].spec.forProvider.subnetIdSelector.matchLabels.zone | string | `"us-east-1b"` |  |
| crossplane-provider-aws-ec2.routeTableAssociations[2].spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-aws-ec2.routeTableAssociations[3].spec.forProvider.region | string | `"us-east-1"` |  |
...
| crossplane-provider-aws-ec2.routeTableAssociations[3].spec.forProvider.subnetIdSelector.matchLabels.zone | string | `"us-east-1b"` |  |
| crossplane-provider-aws-ec2.routeTableAssociations[3].spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
| crossplane-provider-aws-ec2.routeTables | list | `[{"name":"dev-us-ekscluster","spec":{"forProvider":{"region":"us-west-2","vpcIdSelector":{"matchControllerRef":true}},"providerConfigRef":{"name":"dev-us-aws"}}},{"name":"reference-eks-network","spec":{"forProvider":{"region":"us-east-1","tags":{"Name":"platform-ref-eks-network-route-table"},"vpcIdSelector":{"matchControllerRef":true}},"providerConfigRef":{"name":"dev-us-aws"}}}]` | https://marketplace.upbound.io/providers/upbound/provider-aws-ec2/v1.11.0/resources/ec2.aws.upbound.io/RouteTable/v1beta1 |
...
| crossplane-provider-aws-ec2.routes[0].spec.forProvider.region | string | `"us-east-1"` |  |
| crossplane-provider-aws-ec2.routes[0].spec.forProvider.routeTableIdSelector.matchControllerRef | bool | `true` |  |
| crossplane-provider-aws-ec2.routes[0].spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-aws-ec2.securityGroupRules[0].spec.forProvider.region | string | `"us-east-1"` |  |
...
| crossplane-provider-aws-ec2.securityGroupRules[0].spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-aws-ec2.securityGroupRules[1].spec.forProvider.region | string | `"us-east-1"` |  |
...
| crossplane-provider-aws-ec2.securityGroupRules[1].spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-aws-ec2.securityGroups[0].spec.forProvider.region | string | `"us-east-1"` |  |
...
| crossplane-provider-aws-ec2.securityGroups[0].spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
| crossplane-provider-aws-ec2.subnets | list | `[{"annotations":{},"labels":{},"name":"dev-us-ekscluster","ownerReferences":{},"spec":{"forProvider":{"availabilityZone":"us-west-2a","cidrBlock":"192.168.50.0/24","mapPublicIpOnLaunch":false,"region":"us-west-2","vpcIdSelector":{"matchControllerRef":true}},"providerConfigRef":{"name":"dev-us-aws"}}},{"annotations":{},"labels":{},"name":"reference-eks-network","ownerReferences":{},"spec":{"forProvider":{"availabilityZone":"us-east-1a","cidrBlock":"192.168.128.0/18","region":"us-east-1","tags":{"Name":"platform-ref-eks-network-subnet-us-east-1a-private-2","kubernetes.io/role/internal-elb":"1"},"vpcIdSelector":{"matchControllerRef":true}},"providerConfigRef":{"name":"dev-us-aws"}}},{"annotations":{},"labels":{},"name":"reference-eks-network-public-0","ownerReferences":{},"spec":{"forProvider":{"availabilityZone":"us-east-1a","cidrBlock":"192.168.0.0/18","mapPublicIpOnLaunch":true,"region":"us-east-1","tags":{"Name":"platform-ref-eks-network-subnet-us-east-1a-public-0","kubernetes.io/role/elb":"1"},"vpcIdSelector":{"matchControllerRef":true}},"providerConfigRef":{"name":"dev-us-aws"}}},{"annotations":{},"labels":{},"name":"reference-eks-network-us-east-1b-private-3","ownerReferences":{},"spec":{"forProvider":{"availabilityZone":"us-east-1b","cidrBlock":"192.168.192.0/18","region":"us-east-1","tags":{"Name":"platform-ref-eks-network-subnet-us-east-1b-private-3","kubernetes.io/role/internal-elb":"1"},"vpcIdSelector":{"matchControllerRef":true}},"providerConfigRef":{"name":"dev-us-aws"}}},{"annotations":{},"labels":{},"name":"reference-eks-network-us-east-1b-public-1","ownerReferences":{},"spec":{"forProvider":{"availabilityZone":"us-east-1b","cidrBlock":"192.168.64.0/18","mapPublicIpOnLaunch":true,"region":"us-east-1","tags":{"Name":"platform-ref-eks-network-subnet-us-east-1b-public-1","kubernetes.io/role/elb":"1"},"vpcIdSelector":{"matchControllerRef":true}},"providerConfigRef":{"name":"dev-us-aws"}}},{"annotations":{},"labels":{},"name":"dev-us-ekscluster-2","ownerReferences":{},"spec":{"forProvider":{"availabilityZone":"us-west-2b","cidrBlock":"192.168.51.0/24","mapPublicIpOnLaunch":false,"region":"us-west-2","vpcIdSelector":{"matchControllerRef":true}},"providerConfigRef":{"name":"dev-us-aws"}}},{"annotations":{},"labels":{},"name":"dev-us-ekscluster-3","ownerReferences":{},"spec":{"forProvider":{"availabilityZone":"us-west-2b","cidrBlock":"192.168.49.0/24","mapPublicIpOnLaunch":true,"region":"us-west-2","vpcIdSelector":{"matchControllerRef":true}},"providerConfigRef":{"name":"dev-us-aws"}}},{"annotations":{},"labels":{},"name":"dev-us-ekscluster-4","ownerReferences":{},"spec":{"forProvider":{"availabilityZone":"us-west-2b","cidrBlock":"192.168.49.0/24","mapPublicIpOnLaunch":true,"region":"us-west-2","vpcIdSelector":{"matchControllerRef":true}},"providerConfigRef":{"name":"dev-us-aws"}}}]` | https://marketplace.upbound.io/providers/upbound/provider-aws-ec2/v1.11.0/resources/ec2.aws.upbound.io/Subnet/v1beta1 |
| crossplane-provider-aws-ec2.vpcs | list | `[{"annotations":{},"labels":{},"name":"dev-us-ekscluster","ownerReferences":{},"spec":{"forProvider":{"cidrBlock":"192.168.48.0/20","enableDnsHostnames":true,"enableDnsSupport":true,"region":"us-west-2"},"providerConfigRef":{"name":"dev-us-aws"}}},{"annotations":{},"labels":{},"name":"reference-eks-network","ownerReferences":{},"spec":{"forProvider":{"cidrBlock":"192.168.0.0/16","enableDnsHostnames":true,"enableDnsSupport":true,"region":"us-east-1","tags":{"Name":"platform-ref-eks-network-vpc"}},"providerConfigRef":{"name":"dev-us-aws"}}},{"annotations":{},"labels":{},"name":"vpc-us-west-2","ownerReferences":{},"spec":{"forProvider":{"enableDnsHostNames":true,"enableDnsSupport":true,"instanceTenancy":"default","region":"us-west-2","vpcCidrBlock":"10.0.0.0/16"},"providerConfigRef":{"name":"dev-us-aws"}}}]` | https://marketplace.upbound.io/providers/upbound/provider-aws-ec2/v1.11.0/resources/ec2.aws.upbound.io/VPC/v1beta1 |
...
| crossplane-provider-aws-eks.clusters[0].labels."crossplane.io/composite" | string | `"dev-us-ekscluster"` |  |
| crossplane-provider-aws-eks.clusters[0].name | string | `"dev-us-ekscluster"` |  |
...
| crossplane-provider-aws-eks.clusters[0].ownerReferences[0].kind | string | `"XEKSCluster"` |  |
| crossplane-provider-aws-eks.clusters[0].ownerReferences[0].name | string | `"dev-us-ekscluster"` |  |
| crossplane-provider-aws-eks.clusters[0].ownerReferences[0].uid | string | `""` |  |
| crossplane-provider-aws-eks.clusters[0].spec.forProvider.region | string | `"us-west-2"` |  |
...
| crossplane-provider-aws-eks.clusters[0].spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
| crossplane-provider-aws-eks.clusters[0].spec.publishConnectionDetailsTo | object | `{}` |  |
| crossplane-provider-aws-eks.clusters[0].spec.writeConnectionSecretToRef.name | string | `"dev-us-connection-secret"` |  |
...
| crossplane-provider-aws-eks.nodeGroups[0].labels."crossplane.io/composite" | string | `"dev-us-ekscluster"` |  |
| crossplane-provider-aws-eks.nodeGroups[0].name | string | `"dev-us-ekscluster"` |  |
...
| crossplane-provider-aws-eks.nodeGroups[0].ownerReferences[0].kind | string | `"XEKSCluster"` |  |
| crossplane-provider-aws-eks.nodeGroups[0].ownerReferences[0].name | string | `"dev-us-ekscluster"` |  |
| crossplane-provider-aws-eks.nodeGroups[0].ownerReferences[0].uid | string | `""` |  |
| crossplane-provider-aws-eks.nodeGroups[0].spec.forProvider.amiType | string | `"AL2_x86_64"` |  |
...
| crossplane-provider-aws-eks.nodeGroups[0].spec.forProvider.region | string | `"us-west-2"` |  |
...
| crossplane-provider-aws-eks.nodeGroups[0].spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-aws-iam.rolePolicyAttachments[0].labels."crossplane.io/composite" | string | `"dev-us-ekscluster"` |  |
| crossplane-provider-aws-iam.rolePolicyAttachments[0].name | string | `"dev-us-ekscluster"` |  |
...
| crossplane-provider-aws-iam.rolePolicyAttachments[0].ownerReferences[0].kind | string | `"XEKSCluster"` |  |
| crossplane-provider-aws-iam.rolePolicyAttachments[0].ownerReferences[0].name | string | `"dev-us-ekscluster"` |  |
...
| crossplane-provider-aws-iam.rolePolicyAttachments[0].spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-aws-iam.roles[0].labels."crossplane.io/composite" | string | `"dev-us-ekscluster"` |  |
| crossplane-provider-aws-iam.roles[0].name | string | `"dev-us-ekscluster"` |  |
...
| crossplane-provider-aws-iam.roles[0].ownerReferences[0].kind | string | `"XEKSCluster"` |  |
| crossplane-provider-aws-iam.roles[0].ownerReferences[0].name | string | `"dev-us-ekscluster"` |  |
...
| crossplane-provider-aws-iam.roles[0].spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
...
| crossplane-provider-aws-rdr.instances[0].spec.forProvider.passwordSecretRef.name | string | `"dev-us-rds-admin-pw"` |  |
...
| crossplane-provider-aws-rdr.instances[0].spec.forProvider.region | string | `"us-east-1"` |  |
...
| crossplane-provider-aws-rdr.instances[0].spec.providerConfigRef.name | string | `"dev-us-aws"` |  |
| crossplane-provider-aws-rdr.instances[0].spec.writeConnectionSecretToRef.name | string | `"dev-us-rds-connection-details"` |  |
