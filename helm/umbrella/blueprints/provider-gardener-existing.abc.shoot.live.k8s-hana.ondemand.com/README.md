...
|------------|------|---------|
|  https://raw.githubusercontent.com/openmcp-project/blueprint-building-blocks/gh-pages/ | crossplane-gardener-shoot-kubeconfigs(crossplane-gardener-shoot-kubeconfigs) | 0.0.7 |
