...
| oci://ghcr.io/openmcp-project | crossplane-provider-pkgs(crossplane-provider-pkgs) | 0.0.15 |
| oci://ghcr.io/openmcp-project | crossplane-provider-sap-btp-account(crossplane-provider-sap-btp-account) | 0.0.14 |
